...
public enum ResponseEnums {
    ...
    ERROR_SEV_USER_LOGIN(Constant.RESP_CODE_1001, "用户名或密码错误！[BS-3002]"),
    ERROR_SEV_USER_NOT_EXIST(Constant.RESP_CODE_1001, "用户不存在！[BS-3003]"),
    ERROR_SEV_USER_NOT_LOGIN(Constant.RESP_CODE_1001, "用户未登录！[BS-3004]"),
    ERROR_SEV_USER_PASSWORD(Constant.RESP_CODE_1001, "用户密码错误！[BS-3005]"),
